...
export const projectsContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: 'Mood Tracker',
      desc: 'Mood Tracker is an application that the users can log and track their moods over time. This can be immensely helpful for individuals to gain insights into their emotional well-being, identity patterns, and make positive changes in their lives.',
      link: '#',
    },
  ],
};
